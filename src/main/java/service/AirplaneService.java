...
public class AirplaneService {
    ...
    public void changeHeight(Airplane airplane, WayPoint wayPoint, AirplaneCharacteristics characteristics) {
        if (airplane.getPosition().getHeight() < wayPoint.getHeight()) {
            airplane.getPosition().setHeight(Math.min(airplane.getPosition().getHeight() + characteristics.getHeightChange(), wayPoint.getHeight()));
        }
        if (airplane.getPosition().getHeight() > wayPoint.getHeight()) {
            airplane.getPosition().setHeight(Math.max(airplane.getPosition().getHeight() - characteristics.getHeightChange(), wayPoint.getHeight()));
        }

    }

    public void changeSpeed(Airplane airplane, WayPoint wayPoint, AirplaneCharacteristics characteristics) {
        if (airplane.getPosition().getSpeed() < wayPoint.getSpeed()) {
            airplane.getPosition().setSpeed(Math.min(airplane.getPosition().getSpeed() + characteristics.getSpeedChange(), wayPoint.getSpeed()));
        }
        if (airplane.getPosition().getSpeed() > wayPoint.getSpeed()) {
            airplane.getPosition().setSpeed(Math.max(airplane.getPosition().getSpeed() - characteristics.getSpeedChange(), wayPoint.getSpeed()));
        }

    }

    public void rotate(Airplane airplane, WayPoint wayPoint, AirplaneCharacteristics characteristics, Flight flight) {
        ...
        while (currentAngle != angle) {
            if (currentAngle < angle) {
                if (currentAngle + characteristics.getCourseChange() < angle) {
                    ...
                    airplane.getPosition().setCourse(currentAngle + characteristics.getCourseChange());
    ...
    public void move(Airplane airplane, WayPoint wayPoint, AirplaneCharacteristics characteristics) {
        ...
        if (airplane.getPosition().getLatitude() < wayPoint.getLatitude()&&
            ...
            if (airplane.getPosition().getLatitude() + (speed * x / hypotenuse * 3.6 / 111) > wayPoint.getLatitude()
            || airplane.getPosition().getLongitude() + (speed * y / hypotenuse * 3.6 / 111) > wayPoint.getLongitude()) {
                airplane.getPosition().setLatitude(wayPoint.getLatitude());
                airplane.getPosition().setLongitude(wayPoint.getLongitude());
            }
            airplane.getPosition().setLatitude(airplane.getPosition().getLatitude() + (speed * x / hypotenuse * 3.6 / 111));
            airplane.getPosition().setLongitude(airplane.getPosition().getLongitude() + (speed * y / hypotenuse * 3.6 / 111));
        }
